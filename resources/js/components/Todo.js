...
import { LoadTodo , AddTodo , DeleteTodo } from './store/action/action';
    ...
    _FormSubmit  (e) {
        ...
        else
        {
          ...
          this.setState({
           ...
           if ( this.props.TodoData.error === 'true' ) {
              NotificationManager.error('Unable to Handle This Action' , '' , 1000)
            } 
            else{
